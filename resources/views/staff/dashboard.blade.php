...
<body>
    <section id="container">
        ...
        <header class="header fixed-top clearfix">
            <!--logo start-->
            <div class="brand">
                <a href={{URL::to('/staff/dashboard')}} class="logo">
                    DASHBOARD
                </a>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            <li><a href="{{URL::to('/staff/profile')}}"><i class=" fa fa-suitcase"></i>Profile</a></li>
                            <li><a href="{{URL::to('/staff/setting')}}"><i class="fa fa-cog"></i> Settings</a></li>
                            <li><a href="{{URL::to('/staff/logout')}}"><i class="fa fa-key"></i> Log Out</a></li>
                        </ul>
                    </li>
            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        <li>
                            <a class="active" href={{URL::to('/staff/dashboard')}}>
